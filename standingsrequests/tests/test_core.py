...
class TestBaseConfig(NoSocketsTestCase):
    ...
    @patch(MODULE_PATH + ".app_config.EveCharacter.objects.create_character")
    ...
    @patch(MODULE_PATH + ".app_config.SR_OPERATION_MODE", "alliance")
    ...
    @patch(MODULE_PATH + ".app_config.SR_OPERATION_MODE", "corporation")
